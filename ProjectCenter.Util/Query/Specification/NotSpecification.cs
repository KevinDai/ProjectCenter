...
namespace ProjectCenter.Util.Query.Specification
{
    /// <summary>
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="ProjectCenter.Util.Query.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="ProjectCenter.Util.Query.Specification.ISpecification{TEntity}"/></returns>
