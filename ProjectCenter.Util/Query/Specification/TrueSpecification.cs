...
namespace ProjectCenter.Util.Query.Specification
{
        ...
        where TEntity:class
    {
        ...
        /// <summary>
        /// <see cref=" ProjectCenter.Util.Query.Specification.Specification{TEntity}"/>
        /// </summary>
        /// <returns><see cref=" ProjectCenter.Util.Query.Specification.Specification{TEntity}"/></returns>
